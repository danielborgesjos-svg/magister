...
path_obra = r'app/(tenant)/rabisco/obras/[id]/page.tsx'
path_proj = r'app/(tenant)/rabisco/projetos/[id]/page.tsx'

code_obra = '''"use client";
...
with open(path_obra, 'w', encoding='utf-8') as f:
    f.write(code_obra)

with open(path_proj, 'w', encoding='utf-8') as f:
    f.write(code_proj)

print("Obra and Projeto detail pages written successfully!")
